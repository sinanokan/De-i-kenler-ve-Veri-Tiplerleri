...
/*
Önemli Notlar;
1-) Bir değişkenin mutlaka değeri olmalı, eğer ki o anlık değer vermek istemiyorsan "null" olarak belirtmeliyiz.
2-) Değişkenler case sensitive yani büyük küçük harf duyarlıdır.
3-) Değişken isimleri boşluk içeremez. Yalnızca "_" ifadesi kullanılabilir.
4-) Değişken isimlerinin arasında matematiksel ifadeler yani işlem operatörleri kullanılamaz.
5-) Class namespace gibi özel isimler kullanılamaz.
6-) Değişkenlerin her zaman bir değeri olmak zorundadır. Yoksa null tanımlanmalıdır. Ataması yapılmayan değişkenler kullanıldığında derleyici hata verir.
*/
// Veri tipleri
 ...
 byte b = 5;         //0-255 1byte
  ...
  DateTime dt = DateTime.Now;     // Anlık olarak saat ve tarihi verir.
            ...
            string strName = "Sinan Okan Yurtsever";
            string name = "Sinan Okan";
            string surname = "Yurtsever";
